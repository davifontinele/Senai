programa
{
	...
	escolha(opcao){
		...
		escolha(opcao){
			...
			leia(trouco)
			limpa()
			enquanto(trouco<total){//loop utilizado para testar se o valor pago pelo cliente e menor que o valor (R$) total da compra
				titulo()
			...
			trouco=trouco-total//calculando o trouco do cliente (touco = valor pago - total da compra)
			escreva("Pagamento concluindo.\nDevolva um total de R$",trouco," para o cliente.\n\n\n")
	...
	funcao vazio menuProdutos(cadeia matzEstoque[][]){
		...
		escreva("|   | 0  |    |  | ", matzEstoque[0][0],"\n")
		escreva("|    ====     |   =============   |\n")
		escreva("|    ____     |   _____________   | \n")
		escreva("|   | 1  |    |  | ", matzEstoque[1][0],"\n")
          escreva("|    ====     |   =============   |\n")
          escreva("|    ____     |   ____________    |\n")
		escreva("|   | 2  |    |  | ", matzEstoque[2][0],"\n")
		escreva("|    ====     |   =============   |\n")
          escreva("|    ____     |   ____________    | \n")
		escreva("|   | 3  |    |  | ", matzEstoque[3][0],"\n")
          escreva("|    ====     |   ============    |\n")
          escreva("|    ____     |   ____________    | \n")
		escreva("|   | 4  |    |  | ", matzEstoque[4][0],"\n")
          escreva("|    ====     |   ============    | \n")
          escreva("|_____________|___________________|\n")
	}
